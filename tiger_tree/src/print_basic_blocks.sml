...
val ir = Translate_IR.make_ir program							(* generating the ir *)
val executable  = Canonize.compile ir                     		(* compiling/code generation *)
val exec_to_reg = Regalloc.registerAlloc executable
val basic_blocks = MIPSBasicBlocks.basicBlocks exec_to_reg
val _           = TextIO.output(TextIO.stdOut, Machine.bbToString basic_blocks)
